...
import cn.asyysy.asyysy.app.annotation.UserToken;
import cn.asyysy.asyysy.app.common.JsonResult;
        ...
        if(method.isAnnotationPresent(UserToken.class)){
            ...
            if(userToken.required()){
                ...
                if(StringUtils.isEmpty(token)){
                    ...
                    response.sendError(JsonResult.ERROR, BaseConstants.MSG.UN_LOGIN_TOKEN);
                    return false;
                }else {
                    //获取token中的用户信息
                    Claims claims;
...
/*                    EntityWrapper<User> entityWrapper = new EntityWrapper<>();
                    ...
                    if(StringUtils.isEmpty(userName)){
                        response.sendError(JsonResult.ERROR, BaseConstants.MSG.UNDEFIND_LOGIN_USER);
                        return false;
                    }
                    request.setAttribute(BaseConstants.LOGIN.SESSION_ID,userName);
                    return true;
                }
            }
        }
