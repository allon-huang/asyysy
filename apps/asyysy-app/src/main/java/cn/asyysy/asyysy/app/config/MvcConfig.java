...
import cn.asyysy.asyysy.app.intercepter.ShortUrl.ShortUrlInterceptor;
import cn.asyysy.asyysy.app.intercepter.SystemInterceptor;
...
public class MvcConfig implements WebMvcConfigurer {
   ...
   /* @Bean
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new SystemInterceptor(systemInfo, env, loginService)).addPathPatterns("/**").excludePathPatterns("/documentation**");
