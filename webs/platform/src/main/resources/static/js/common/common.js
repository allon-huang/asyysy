...
function initSysInfo() {
    common.ajaxPostJson(domain + "/common/sysInfo",null,function (data) {
        sysInfo = data.data;
    },function (data) {
        console.log(data);
    })
...
function wxFun(sysInfo) {
    ...
    wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
        wx.config({
            ...
            appId: sysInfo.appid, // 必填，公众号的唯一标识
            timestamp: sysInfo.timestamp, // 必填，生成签名的时间戳
            nonceStr: sysInfo.nonceStr, // 必填，生成签名的随机串
            signature: sysInfo.signature,// 必填，签名
