package cn.asyysy.asyysy.platform.controller.api.mp;


import cn.asyysy.asyysy.app.common.wechat.CheckoutUtil;
import cn.asyysy.asyysy.app.common.wechat.MessageUtil;
import cn.asyysy.asyysy.common.constants.BaseConstants;
import cn.asyysy.asyysy.app.controller.common.BaseController;
import cn.asyysy.asyysy.app.model.wechat.TextMeaasge;
...
import cn.asyysy.asyysy.app.service.user.WxReplyModelService;
...
public class WxMpConroller extends BaseController {
    ...
    public String  geTokenGetForWx(Model model, @RequestParam Map<String,Object> params, HttpServletRequest request){
        ...
        redisBaseService.delete(BaseConstants.REDIS_KEY.WX_INFO);
        redisBaseService.set(BaseConstants.REDIS_KEY.WX_INFO, wxConfig);
        return returnStr;
    }
